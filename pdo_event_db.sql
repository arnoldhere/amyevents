...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2022 at 12:51 PM
...
(1, 'superadmin@yahoo.in', 'admin@AMY');
...
INSERT INTO `booking` (`id`, `email`, `phone`, `event`, `venue`) VALUES
(2, 'manthan@gmail.com', '1245789632', 'concert', 'New Delhi'),
(3, 'ronaldmacwan4524@gmail.com', '9824504348', 'concert', 'Jaipur'),
(4, 'arnoldmacwan009@gmail.com', '8200781208', 'MUSICAL', 'Ahemdabad'),
(5, 'demo@gmail.com', '1234569', 'Exhibition', 'Jaipur');
...
INSERT INTO `eventcategory` (`id`, `eventCategory`, `creationDate`) VALUES
(1, 'Religious ', '2022-10-15 06:27:07'),
(2, 'concert', '2022-10-15 06:28:27'),
(3, 'Exhibition', '2022-10-15 07:15:41'),
(4, 'Family function', '2022-10-15 07:15:55'),
(5, 'sports', '2022-10-15 07:16:02'),
(6, 'Political event', '2022-10-15 07:16:09'),
(8, 'Club party', '2022-10-16 09:04:27'),
(9, 'community', '2022-10-16 10:19:13'),
(10, 'BIRTHDAY', '2022-10-16 10:20:21'),
(11, 'GET TOGETHER', '2022-10-16 10:20:39'),
(12, 'MUSICAL', '2022-10-16 10:20:58'),
(13, 'NIGHT CLUB', '2022-10-16 10:21:10'),
(14, 'POST WEDDING', '2022-10-16 10:21:26'),
(15, 'demoevent', '2022-10-18 08:51:23');
...
(1, 'arnoldmacwan009@outlook.com', 'need to imrove us\r\n'),
(2, 'ronaldmacwan4524@gmail.com', 'need more improvements'),
(4, 'arnoldmacwan009@outlook.com', 'Good UI but need some third party login or signup apps '),
(5, 'arnoldmacwan009@gmail.com', '    Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti dolore facilis repudiandae, rerum reiciendis perspiciatis cum. Iusto eos rerum facilis tempore doloribus, assumenda et repellat voluptate necessitatibus numquam dicta inventore iste, mo'),
(6, 'arnoldmacwan009@gmail.com', 'demo feedback');
...
--
-- Table structure for table `venuecity`
--
...
--
-- Dumping data for table `venuecity`
--

INSERT INTO `venuecity` (`id`, `name`) VALUES
(1, 'Ahemdabad'),
(2, 'Jaipur'),
(3, 'Goa '),
(4, 'Chennai'),
...
--
-- Indexes for table `venuecity`
--
ALTER TABLE `venuecity`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `venuecity`
--
ALTER TABLE `venuecity`
