                        ...
                        <div class="col-12 col-md-10 col-lg-7 col-xl-6">
                            <div class="card mask-custom">
                                <div class="card-body p-5 text-danger">
                                    <div class="my-4">
                                        <h2 class="p-4 shadow-4 text-bg-info rounded-3 text-center mb-5" style="background-color: hsl(0, 0%, 94%);">Book Event</h2>
                                        <form class="form" name="bookform" id="bookform" enctype="multipart/form-data" method="POST" action="bookinghandle.php">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6 mb-4">
                                                    <div class="form-outline ">
                                                        <input type="text" id="form3Example2" class="form-control form-control-lg" name="phone" required />
                                                        <label class="form-label" for="form3Example2">Enter phone</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <select class="form-select p-1" name="event">
                                                <option value="" selected disabled>--Event--</option>
                                                <?php
                                                $stmtevent = $conn->prepare('SELECT * FROM eventcategory');
                                                $stmtevent->execute();
                                                $events = $stmtevent->fetchAll(PDO::FETCH_ASSOC);
                                                foreach ($events as $event) {
                                                ?>
                                                    <option value="<?php echo $event['eventCategory']; ?>"><?php echo $event['eventCategory']; ?></option>
                                                <?php
                                                }
                                            ...
                                            <div class="form-outline  mb-4">
                                                <label class="form-label" for="form3Example3">Select venue city</label>
                                                <select name="venue" id="venue" class="form-select p-1">
                                                    <option value="" selected disabled>--Select--</option>
                                                    <?php
                                                    $stmt = $conn->prepare('SELECT * FROM venueCity');
                                                    $stmt->execute();
                                                    ...
                                                    ?>
                                                        <option value="<?php
                                                                        echo $result['name'];
                                                                        ?>" class="text-dark"><?php echo $result['name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <!-- Checkbox -->
                                            <div class="form-check d-flex justify-content-center mb-4">
                                                ...
                                                <label class="form-check-label text-muted" for="form2Example3">
                                                    Send update on email
                                                </label>
                                            </div>

                                            <!-- Submit button -->
                                            <button type="submit" name="btn" class="btn btn-danger btn-block mb-4">Select</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
