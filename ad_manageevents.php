...
<head>
    ...
    <title>AMY events | Manage Events</title>
    <!-- CSS only -->
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card mt-lg-5">
                <div class="modal-header">
                    <h5 class="modal-title" style="float: left;">Events</h5>
                ...
                <!-- Modal -->
                <div class="modal fade" id="addsector" tabindex="-1" aria-labelledby="addsector" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add event category</h5>
                                <button type="button" class="btn-close" data-mdb-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="ad_addevent.php" method="POST" class="form" role="form" name="addsector">
                                    <div class="row">
                ...
                <div class="totalevent">
                    <span class="badge badge-danger p-3 mx-3 mt-1">
                        <?php
                        echo htmlentities("Total Events " . $prepare->rowCount());
                        ?>
                    </span>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="font-w600">
                                            <!-- event category using php -->
                                            <?php
                                            echo htmlentities($event['eventCategory']);
                                            ?>
                                        </td>
                                        <td class="d-none d-sm-table-cell">
                                            <!-- creation date using php -->
                                            <?php
                                            echo htmlentities($event['creationDate']);
                                            ?>
                                        </td>
                                        <td class="text-center">
                                            <!-- delete action of event category using php -->
                                            <a href="ad_delevent.php?delid=<?php echo $event['id']; ?>" onclick="return confirm('Do you want to delete ?')">
